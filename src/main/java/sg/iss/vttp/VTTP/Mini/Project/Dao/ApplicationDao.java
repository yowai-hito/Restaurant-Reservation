...
public interface ApplicationDao {
  ...
  // Reservations
  public static final String SQL_RESV_CREATE = "INSERT INTO reservations(Reservation_Id, restaurant_name ,customer_name, customer_pax, reservation_datetime)" +
  " VALUES (?,?,?,?,?) ";
  ...
  public static final String SQL_RESV_VIEW_RESERVATIONS_BY_CNAME = "SELECT Reservation_Id, restaurant_name, customer_name, customer_pax, reservation_datetime, reservation_status " +
  ...
  public static final String SQL_RESV_DELETE_RESERVATION_WITH_ID = "DELTE FROM reservations WHERE Reservationd_Id = ?";
